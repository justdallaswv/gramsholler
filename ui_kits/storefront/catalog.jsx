...
const PRODUCTS = [
  ...
  { id: "washcloths", name: "Upcycled Washcloths", category: "Textiles", price: 5, stock: "stock",
    blurb: "Hand-stitched washcloths made entirely with upcycled materials.",
    story: "Giving new purpose to honest textiles. We gather quality scrap materials and re-work them into sturdy, reliable washcloths built for daily chore work or washing up on the porch." },
  ...
  { id: "lye_soap", name: "Traditional Lye Soap", category: "Homestead", price: 4, stock: "stock",
    blurb: "Lye soap made the old-fashioned way with no dyes.",
    story: "Unscented, un-dyed, and honest. Made using traditional cold processes at the workbench for a deep, pure clean that doesn't hide behind artificial colors or synthetic perfumes." },
